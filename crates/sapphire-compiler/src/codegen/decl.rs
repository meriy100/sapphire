...
pub fn render_module(
    ...
    buf.push_line("#");
    buf.push_line("# Generated by sapphire-compiler. Do not edit by hand.");
    buf.push_line("# See docs/build/02-source-and-output-layout.md for the output contract.");
    buf.blank();

    // Requires: always the prelude (which pulls the runtime), and
    // cross-module requires for every imported module. Prelude is
    // implicit (spec 09) and is `require`d unconditionally.
