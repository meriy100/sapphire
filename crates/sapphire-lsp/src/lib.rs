...
//!
//! At L4 / L5 / L6 this crate exposes a `tower-lsp` based server that
...
//! against the I5 resolver side table, answers `textDocument/hover`
//! with inferred-type tooltips from I6, and serves
//! `textDocument/completion` by walking the resolver's in-scope
//! tables.
...
//! hover design, `docs/impl/31-lsp-completion.md` for the L6
//! completion design, and `docs/impl/07-lsp-stack.md` for the
